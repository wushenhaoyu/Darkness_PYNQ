...
// ==============================================================
#ifndef __LeakyReLU_mul_muldEe__HH__
#define __LeakyReLU_mul_muldEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LeakyReLU_mul_muldEe) {
    ...
    SC_CTOR(LeakyReLU_mul_muldEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
