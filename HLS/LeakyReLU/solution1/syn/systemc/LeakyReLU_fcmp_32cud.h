...
// ==============================================================
#ifndef __LeakyReLU_fcmp_32cud__HH__
#define __LeakyReLU_fcmp_32cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LeakyReLU_fcmp_32cud) {
    ...
    SC_CTOR(LeakyReLU_fcmp_32cud):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
