...
// ==============================================================
`timescale 1ns/1ps
module LeakyReLU_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER              = 6'h08,
    ADDR_ISR              = 6'h0c,
    ADDR_CHANNEL_V_DATA_0 = 6'h10,
    ADDR_CHANNEL_V_CTRL   = 6'h14,
    ADDR_HEIGHT_V_DATA_0  = 6'h18,
    ADDR_HEIGHT_V_CTRL    = 6'h1c,
    ADDR_WIDTH_V_DATA_0   = 6'h20,
    ADDR_WIDTH_V_CTRL     = 6'h24,
    ADDR_IN_DATA_DATA_0   = 6'h28,
    ADDR_IN_DATA_CTRL     = 6'h2c,
    ADDR_OUT_DATA_DATA_0  = 6'h30,
    ADDR_OUT_DATA_CTRL    = 6'h34,
    ADDR_ALPHA_DATA_0     = 6'h38,
    ADDR_ALPHA_CTRL       = 6'h3c,
    WRIDLE                = 2'd0,
    WRDATA                = 2'd1,
    WRRESP                = 2'd2,
    WRRESET               = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CHANNEL_V_DATA_0: begin
                    rdata <= int_channel_V[11:0];
                end
...
assign channel_V = int_channel_V;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_V[11:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CHANNEL_V_DATA_0)
            int_channel_V[11:0] <= (WDATA[31:0] & wmask) | (int_channel_V[11:0] & ~wmask);
    end
end
