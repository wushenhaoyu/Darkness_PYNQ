...
// ==============================================================
#ifndef __GELU_mul_mul_12nspcA__HH__
#define __GELU_mul_mul_12nspcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(GELU_mul_mul_12nspcA) {
    ...
    SC_CTOR(GELU_mul_mul_12nspcA):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
