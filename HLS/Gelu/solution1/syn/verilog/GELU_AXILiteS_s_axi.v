...
localparam
    ...
    ADDR_IER                   = 6'h08,
    ADDR_ISR                   = 6'h0c,
    ADDR_INPUT_WIDTH_V_DATA_0  = 6'h10,
    ADDR_INPUT_WIDTH_V_CTRL    = 6'h14,
    ADDR_INPUT_HEIGHT_V_DATA_0 = 6'h18,
    ADDR_INPUT_HEIGHT_V_CTRL   = 6'h1c,
    ADDR_INPUT_DEPTH_V_DATA_0  = 6'h20,
    ADDR_INPUT_DEPTH_V_CTRL    = 6'h24,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INPUT_DEPTH_V_DATA_0: begin
                    rdata <= int_input_depth_V[7:0];
                end
...
assign input_depth_V  = int_input_depth_V;
...
// int_input_depth_V[7:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_input_depth_V[7:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_INPUT_DEPTH_V_DATA_0)
            int_input_depth_V[7:0] <= (WDATA[31:0] & wmask) | (int_input_depth_V[7:0] & ~wmask);
    end
end
