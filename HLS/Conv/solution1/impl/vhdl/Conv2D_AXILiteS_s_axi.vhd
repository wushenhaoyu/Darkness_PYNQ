...
architecture behave of Conv2D_AXILiteS_s_axi is
    ...
    constant ADDR_IN_CHANNEL_V_DATA_0   : INTEGER := 16#10#;
    constant ADDR_IN_CHANNEL_V_CTRL     : INTEGER := 16#14#;
    constant ADDR_OUT_CHANNEL_V_DATA_0  : INTEGER := 16#18#;
    constant ADDR_OUT_CHANNEL_V_CTRL    : INTEGER := 16#1c#;
    constant ADDR_KERNEL_SIZE_V_DATA_0  : INTEGER := 16#20#;
    constant ADDR_KERNEL_SIZE_V_CTRL    : INTEGER := 16#24#;
    constant ADDR_STRIDE_V_DATA_0       : INTEGER := 16#28#;
    constant ADDR_STRIDE_V_CTRL         : INTEGER := 16#2c#;
    constant ADDR_PADDING_V_DATA_0      : INTEGER := 16#30#;
    constant ADDR_PADDING_V_CTRL        : INTEGER := 16#34#;
    constant ADDR_INPUT_WIDTH_V_DATA_0  : INTEGER := 16#38#;
...
-- ----------------------- Register logic ----------------
    ...
    in_channel_V         <= STD_LOGIC_VECTOR(int_in_channel_V);
    out_channel_V        <= STD_LOGIC_VECTOR(int_out_channel_V);
    kernel_size_V        <= STD_LOGIC_VECTOR(int_kernel_size_V);
