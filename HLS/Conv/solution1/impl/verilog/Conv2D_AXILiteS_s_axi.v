...
localparam
    ...
    ADDR_IER                   = 7'h08,
    ADDR_ISR                   = 7'h0c,
    ADDR_IN_CHANNEL_V_DATA_0   = 7'h10,
    ADDR_IN_CHANNEL_V_CTRL     = 7'h14,
    ADDR_OUT_CHANNEL_V_DATA_0  = 7'h18,
    ADDR_OUT_CHANNEL_V_CTRL    = 7'h1c,
    ADDR_KERNEL_SIZE_V_DATA_0  = 7'h20,
    ADDR_KERNEL_SIZE_V_CTRL    = 7'h24,
    ADDR_STRIDE_V_DATA_0       = 7'h28,
    ADDR_STRIDE_V_CTRL         = 7'h2c,
    ADDR_PADDING_V_DATA_0      = 7'h30,
    ADDR_PADDING_V_CTRL        = 7'h34,
    ADDR_INPUT_WIDTH_V_DATA_0  = 7'h38,
...
assign in_channel_V   = int_in_channel_V;
assign out_channel_V  = int_out_channel_V;
assign kernel_size_V  = int_kernel_size_V;
