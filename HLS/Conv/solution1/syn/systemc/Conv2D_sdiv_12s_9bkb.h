...
// ==============================================================
#ifndef __Conv2D_sdiv_12s_9bkb__HH__
#define __Conv2D_sdiv_12s_9bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv2D_sdiv_12s_9bkb) {
    ...
    ACMP_sdiv_seq<ID, 16, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(Conv2D_sdiv_12s_9bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
