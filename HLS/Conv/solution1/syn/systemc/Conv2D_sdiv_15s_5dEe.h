...
// ==============================================================
#ifndef __Conv2D_sdiv_15s_5dEe__HH__
#define __Conv2D_sdiv_15s_5dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv2D_sdiv_15s_5dEe) {
    ...
    ACMP_sdiv_seq<ID, 19, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(Conv2D_sdiv_15s_5dEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
