...
// ==============================================================
#ifndef __Conv2D_mul_mul_24dEe__HH__
#define __Conv2D_mul_mul_24dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv2D_mul_mul_24dEe) {
    ...
    SC_CTOR(Conv2D_mul_mul_24dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
