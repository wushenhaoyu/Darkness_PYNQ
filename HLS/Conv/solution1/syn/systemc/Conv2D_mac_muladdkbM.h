...
// ==============================================================
#ifndef __Conv2D_mac_muladdkbM__HH__
#define __Conv2D_mac_muladdkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv2D_mac_muladdkbM) {
    ...
    SC_CTOR(Conv2D_mac_muladdkbM):  simcore_mac_3_U ("simcore_mac_3_U") {
