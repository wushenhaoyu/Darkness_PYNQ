...
// ==============================================================
#ifndef __Conv2D_mac_muladdjbC__HH__
#define __Conv2D_mac_muladdjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv2D_mac_muladdjbC) {
    ...
    SC_CTOR(Conv2D_mac_muladdjbC):  simcore_mac_2_U ("simcore_mac_2_U") {
