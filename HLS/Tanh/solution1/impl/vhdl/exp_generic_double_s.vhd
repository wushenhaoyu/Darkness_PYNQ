...
architecture behav of exp_generic_double_s is 
    ...
    component Tanh_mul_72ns_13seOg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Tanh_mac_muladd_1fYi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Tanh_mul_72ns_13seOg_U1 : component Tanh_mul_72ns_13seOg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 72,
    ...
    Tanh_mac_muladd_1fYi_U2 : component Tanh_mac_muladd_1fYi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
