...
// ==============================================================
#ifndef __Tanh_mul_mul_12nsncg__HH__
#define __Tanh_mul_mul_12nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_mul_mul_12nsncg) {
    ...
    SC_CTOR(Tanh_mul_mul_12nsncg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
