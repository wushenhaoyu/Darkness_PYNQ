...
// ==============================================================
#ifndef __Tanh_fdiv_32ns_32ibs__HH__
#define __Tanh_fdiv_32ns_32ibs__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_fdiv_32ns_32ibs) {
    ...
    SC_CTOR(Tanh_fdiv_32ns_32ibs):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
