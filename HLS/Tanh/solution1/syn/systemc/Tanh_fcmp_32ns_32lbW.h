...
// ==============================================================
#ifndef __Tanh_fcmp_32ns_32lbW__HH__
#define __Tanh_fcmp_32ns_32lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_fcmp_32ns_32lbW) {
    ...
    SC_CTOR(Tanh_fcmp_32ns_32lbW):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
