...
// ==============================================================
#ifndef __Tanh_dadd_64ns_64mb6__HH__
#define __Tanh_dadd_64ns_64mb6__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_dadd_64ns_64mb6) {
    ...
    SC_CTOR(Tanh_dadd_64ns_64mb6):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
