...
// ==============================================================
#ifndef __Tanh_fptrunc_64nsjbC__HH__
#define __Tanh_fptrunc_64nsjbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_fptrunc_64nsjbC) {
    ...
    SC_CTOR(Tanh_fptrunc_64nsjbC):  ACMP_fptrunc_comb_U ("ACMP_fptrunc_comb_U") {
