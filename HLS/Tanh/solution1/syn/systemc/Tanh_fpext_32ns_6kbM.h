...
// ==============================================================
#ifndef __Tanh_fpext_32ns_6kbM__HH__
#define __Tanh_fpext_32ns_6kbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_fpext_32ns_6kbM) {
    ...
    SC_CTOR(Tanh_fpext_32ns_6kbM):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
