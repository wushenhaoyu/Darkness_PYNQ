...
// ==============================================================
#ifndef __Tanh_faddfsub_32ng8j__HH__
#define __Tanh_faddfsub_32ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Tanh_faddfsub_32ng8j) {
    ...
    SC_CTOR(Tanh_faddfsub_32ng8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
