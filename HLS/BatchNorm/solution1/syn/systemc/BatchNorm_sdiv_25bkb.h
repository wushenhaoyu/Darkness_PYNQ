...
// ==============================================================
#ifndef __BatchNorm_sdiv_25bkb__HH__
#define __BatchNorm_sdiv_25bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BatchNorm_sdiv_25bkb) {
    ...
    SC_CTOR(BatchNorm_sdiv_25bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
