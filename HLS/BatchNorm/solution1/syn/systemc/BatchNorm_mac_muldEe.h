...
// ==============================================================
#ifndef __BatchNorm_mac_muldEe__HH__
#define __BatchNorm_mac_muldEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BatchNorm_mac_muldEe) {
    ...
    SC_CTOR(BatchNorm_mac_muldEe):  simcore_mac_0_U ("simcore_mac_0_U") {
