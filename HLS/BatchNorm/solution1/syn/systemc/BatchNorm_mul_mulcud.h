...
// ==============================================================
#ifndef __BatchNorm_mul_mulcud__HH__
#define __BatchNorm_mul_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BatchNorm_mul_mulcud) {
    ...
    SC_CTOR(BatchNorm_mul_mulcud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
