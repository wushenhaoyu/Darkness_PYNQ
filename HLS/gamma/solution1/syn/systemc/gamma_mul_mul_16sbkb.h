...
// ==============================================================
#ifndef __gamma_mul_mul_16sbkb__HH__
#define __gamma_mul_mul_16sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(gamma_mul_mul_16sbkb) {
    ...
    SC_CTOR(gamma_mul_mul_16sbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
