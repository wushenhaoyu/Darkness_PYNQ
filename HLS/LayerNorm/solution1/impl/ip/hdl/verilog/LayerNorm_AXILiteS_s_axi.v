...
// ==============================================================
`timescale 1ns/1ps
module LayerNorm_AXILiteS_s_axi
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [15:0]                   num_features_V,
...
//------------------------Local signal-------------------
    ...
    reg  [15:0]                   int_num_features_V = 'b0;
...
// int_num_features_V[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_num_features_V[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_NUM_FEATURES_V_DATA_0)
            int_num_features_V[15:0] <= (WDATA[31:0] & wmask) | (int_num_features_V[15:0] & ~wmask);
    end
end
