...
// ==============================================================
#ifndef __LayerNorm_mac_mulfYi__HH__
#define __LayerNorm_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(LayerNorm_mac_mulfYi) {
    ...
    SC_CTOR(LayerNorm_mac_mulfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
