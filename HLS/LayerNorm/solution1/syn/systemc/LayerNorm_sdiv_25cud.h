...
// ==============================================================
#ifndef __LayerNorm_sdiv_25cud__HH__
#define __LayerNorm_sdiv_25cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LayerNorm_sdiv_25cud) {
    ...
    SC_CTOR(LayerNorm_sdiv_25cud):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
