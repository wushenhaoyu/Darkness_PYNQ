...
// ==============================================================
#ifndef __LayerNorm_sdiv_17bkb__HH__
#define __LayerNorm_sdiv_17bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LayerNorm_sdiv_17bkb) {
    ...
    SC_CTOR(LayerNorm_sdiv_17bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
