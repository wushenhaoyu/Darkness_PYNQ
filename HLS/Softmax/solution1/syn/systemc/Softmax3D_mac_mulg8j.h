...
// ==============================================================
#ifndef __Softmax3D_mac_mulg8j__HH__
#define __Softmax3D_mac_mulg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Softmax3D_mac_mulg8j) {
    ...
    SC_CTOR(Softmax3D_mac_mulg8j):  simcore_mac_0_U ("simcore_mac_0_U") {
