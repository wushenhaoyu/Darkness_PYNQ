...
// ==============================================================
#ifndef __Softmax3D_mul_muleOg__HH__
#define __Softmax3D_mul_muleOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Softmax3D_mul_muleOg) {
    ...
    SC_CTOR(Softmax3D_mul_muleOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
