...
// ==============================================================
#ifndef __Softmax3D_fdiv_32cud__HH__
#define __Softmax3D_fdiv_32cud__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Softmax3D_fdiv_32cud) {
    ...
    SC_CTOR(Softmax3D_fdiv_32cud):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
