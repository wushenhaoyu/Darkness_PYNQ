...
// ==============================================================
#ifndef __Softmax3D_mac_mulhbi__HH__
#define __Softmax3D_mac_mulhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Softmax3D_mac_mulhbi) {
    ...
    SC_CTOR(Softmax3D_mac_mulhbi):  simcore_mac_1_U ("simcore_mac_1_U") {
