...
// ==============================================================
#ifndef __Softmax3D_mul_mulfYi__HH__
#define __Softmax3D_mul_mulfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Softmax3D_mul_mulfYi) {
    ...
    SC_CTOR(Softmax3D_mul_mulfYi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
