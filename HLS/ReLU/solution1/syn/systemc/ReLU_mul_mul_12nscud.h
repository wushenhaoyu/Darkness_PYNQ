...
// ==============================================================
#ifndef __ReLU_mul_mul_12nscud__HH__
#define __ReLU_mul_mul_12nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ReLU_mul_mul_12nscud) {
    ...
    SC_CTOR(ReLU_mul_mul_12nscud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
