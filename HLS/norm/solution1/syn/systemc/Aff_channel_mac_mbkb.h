...
// ==============================================================
#ifndef __Aff_channel_mac_mbkb__HH__
#define __Aff_channel_mac_mbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Aff_channel_mac_mbkb) {
    ...
    SC_CTOR(Aff_channel_mac_mbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
