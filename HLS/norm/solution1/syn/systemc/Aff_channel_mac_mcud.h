...
// ==============================================================
#ifndef __Aff_channel_mac_mcud__HH__
#define __Aff_channel_mac_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Aff_channel_mac_mcud) {
    ...
    SC_CTOR(Aff_channel_mac_mcud):  simcore_mac_1_U ("simcore_mac_1_U") {
