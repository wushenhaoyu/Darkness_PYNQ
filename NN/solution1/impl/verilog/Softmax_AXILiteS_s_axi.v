...
localparam
    ...
    ADDR_IN_DATA_CTRL    = 6'h14,
    ADDR_OUT_DATA_DATA_0 = 6'h18,
    ADDR_OUT_DATA_CTRL   = 6'h1c,
    ADDR_SIZE_V_DATA_0   = 6'h20,
    ADDR_SIZE_V_CTRL     = 6'h24,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SIZE_V_DATA_0)
            int_size_V[15:0] <= (WDATA[31:0] & wmask) | (int_size_V[15:0] & ~wmask);
    end
end
