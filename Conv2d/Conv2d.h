...
#include <cstdlib>
using namespace std;
typedef ap_fixed<16,5> Dtype_t;   // Data type for input, output, and bias
typedef ap_fixed<16,5> Dtype_w;   // Data type for weights
typedef ap_fixed<16,5> Dtype_acc; // Data type for accumulation
void Conv2D(
